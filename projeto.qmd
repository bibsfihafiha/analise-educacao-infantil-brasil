...
format:
  html:
    embed-resources: true   # << deixa o HTML self-contained (1 arquivo só)
    theme: cosmo
    toc: true
    toc-depth: 2
    number-sections: true
    smooth-scroll: true
# opcional: já sair com nome index.html para GitHub Pages
output-file: index
---

# Introdução e Contexto da Análise
...
## Evolução da Cobertura no Brasil (2007-2024)
...
## Comparativo entre as Grandes Regiões (2007-2024)
...
# Aspectos Técnicos e Reprodutibilidade
